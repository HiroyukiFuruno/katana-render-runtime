...
| --- | --- | --- | --- |
| Mermaid.js | 3.3.1 | `crates/katana-canvas-forge/vendor/mermaid/3.3.1/mermaid.min.js` | `217b66ef4279c33c141b4afe22effad10a91c02558dc70917be2c0981e78ed87` |
| Draw.io | 29.7.10 | `crates/katana-canvas-forge/vendor/drawio/29.7.10/drawio.min.js` | `a8b7897de995a4e7dd3a541a5e7250d64a295440f728f0ddae72179cdf5a83d5` |
...
- `crates/katana-canvas-forge/src/markdown/runtime_assets.rs`
- `crates/katana-canvas-forge/src/renderer/runtime.rs`
- `crates/katana-canvas-forge/src/renderer/output.rs`
- `Justfile`

既定の描画経路では、上記 asset を一時領域の
`katana-canvas-forge/vendor/<runtime>/<version>/` へ展開して読み込む。
