...
export const DrawioResourcePaths = {
  ...
  logical(root: string, filePath: string): string {
...
export const DrawioSourceKind = {
  fromLogicalPath(logicalPath: string): string {
  ...
  firstSegment(logicalPath: string): string {
