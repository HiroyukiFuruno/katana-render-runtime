...
mod tests {
    ...
    #[test]
    fn creates_a_command_for_the_requested_program() {
        let command = ProcessService::create_command("krr-test-command");

        assert_eq!(command.get_program(), "krr-test-command");
    }
}
