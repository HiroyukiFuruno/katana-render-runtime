...
const DRAWIO_JS_RUNTIME = "crates/katana-canvas-forge/src/markdown/drawio_renderer/js_runtime";

export class DrawioRuntimeBundleDefinition {
  static create(): RuntimeBundleDefinition {
    return new RuntimeBundleDefinition(
      "drawio",
      "drawio-runtime.min.js",
      [...SharedDomFragments.all(), ...DrawioRuntimeBundleDefinition.fragments()],
  ...
  private static fragments(): RuntimeFragment[] {
    return [
      RuntimeFragmentFactory.verbatim(
        "drawio-globals.js",
        `${DRAWIO_JS_RUNTIME}/drawio_globals.js`,
      ),
      RuntimeFragmentFactory.verbatim(
        "drawio-resources.js",
