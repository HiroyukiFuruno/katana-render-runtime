...
const RUNTIME_ROOT: &str = "crates/katana-canvas-forge/src/markdown/diagram_runtime";
const GENERATED: &str = "crates/katana-canvas-forge/src/markdown/diagram_runtime/generated";
const SOURCE: &str = "crates/katana-canvas-forge/src/markdown/diagram_runtime/source";
const TS_SCRIPT_ROOT: &str = "scripts";
const REQUIRED_PATHS: &[&str] = &[
    RUNTIME_ROOT,
    GENERATED,
    SOURCE,
    "crates/katana-canvas-forge/src/markdown/diagram_runtime/source/shared",
    "crates/katana-canvas-forge/src/markdown/diagram_runtime/source/mermaid",
    "crates/katana-canvas-forge/src/markdown/diagram_runtime/source/drawio",
    "crates/katana-canvas-forge/src/markdown/diagram_runtime/source/zenuml",
    "crates/katana-canvas-forge/src/markdown/diagram_runtime/generated/mermaid-runtime.min.js",
    "crates/katana-canvas-forge/src/markdown/diagram_runtime/generated/drawio-runtime.min.js",
    "crates/katana-canvas-forge/src/markdown/diagram_runtime/generated/zenuml-runtime.min.js",
    "crates/katana-canvas-forge/src/markdown/diagram_runtime/generated/runtime-bundles.sha256",
...
impl RuntimeBundleRule {
    pub(super) fn check(workspace: &WorkspaceModel) -> Result<Vec<Violation>, KcfLintError> {
    ...
    pub(super) fn ts_files(root: &Path, relative: &str) -> Result<Vec<PathBuf>, KcfLintError> {
    ...
    pub(super) fn read_source(path: &Path) -> Result<String, KcfLintError> {
        std::fs::read_to_string(path).map_err(|source| KcfLintError::Read {
