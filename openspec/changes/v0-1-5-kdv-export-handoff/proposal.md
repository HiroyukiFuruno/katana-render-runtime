...
v0.1.5 では、旧 export/debug 実装 branch の内容をKCFへ再取り込みしない。KDVへ渡すべき論点だけを記録し、KCF側には export や viewer rendering 依存を増やさない。
...
- 旧 export/debug 実装 branch のexport実装をKCF masterへmergeしない
...
- `openspec/changes/v0-1-5-kdv-export-handoff/` — KDV移譲記録
