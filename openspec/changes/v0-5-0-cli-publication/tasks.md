...
- [ ] v0.1.0 から v0.4.0 までの renderer、export、score、viewer rendering の公開 API を確認している
...
- `openspec/changes/v0-5-0-cli-publication`

### タスク

- [ ] 1.1 binary 名と public command 一覧を固定する
- [ ] 1.2 `--help`、`--version`、render、export、score、reference 更新、viewer rendering の output contract を固定する
...
- [ ] 3.6 CSV / PDF / Office viewer rendering の smoke command を release gate に含める
...
- [ ] 4.1 KatanA consumer が必要とする render、export、score、viewer rendering の最小 fixture を定義する
...
- [ ] 5.5 CSV / PDF / Office viewer rendering の CLI smoke を実行する
...
- [ ] 5.10 `npx -y @fission-ai/openspec validate v0-5-0-cli-publication --strict` を実行する
