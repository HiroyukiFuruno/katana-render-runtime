...
- `crates/katana-diagram-renderer-cli`
- `crates/katana-diagram-renderer`
...
- [ ] CSV / PDF / Office viewer rendering がKDR CLI公開範囲へ戻っていない
...
- [ ] 4.5 KDVへ移譲した viewer/export fixture をKDR互換性fixtureに含めない
...
- [ ] 5.5 KDVへ移譲した viewer/export smoke がKDR側に残っていないことを確認する
