...
v0.1.1 は「最低点を 99 以上へ上げる最終フェーズ」である。
...
2. 失敗 fixture を含む最小 fixture directory だけを `just drawio-compare <fixture-dir> 99 tmp/kdr-v0.1.1-reference-score-improvement/<case>` で再実行する
...
7. 失敗が full compare でだけ出る場合は、該当 fixture を含む最小 fixture directory だけを `just drawio-compare <fixture-dir> 99 tmp/kdr-v0.1.1-reference-score-improvement/full-<slug>` で切り出す
