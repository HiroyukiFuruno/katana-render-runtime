...
- **THEN** v0.1.1 で修正しない case はユーザー確認後に別 change へ送り、理由と score を report に残す
...
- **THEN** 該当 fixture を含む最小 fixture directory だけを `just drawio-compare <fixture-dir> 99 tmp/kdr-v0.1.1-reference-score-improvement/<case>` で再実行する
