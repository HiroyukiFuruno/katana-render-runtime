...
この範囲は旧 v0.1.1 / v0.1.2 として Jules 側へ渡していたが、粒度が大きく進捗が停滞している。先に小さい `export CSS debug` を v0.1.2、Mermaid ZenUML / unsupported fixture handling を v0.1.3 として閉じ、score 改善（score improvement）を v0.1.4 の最終フェーズへ送る。
