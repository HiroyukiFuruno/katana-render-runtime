...
unsupported fixture は暗黙 skip しない。Mermaid ZenUML / unsupported fixture handling は v0.1.3 で固定し、v0.1.4 はその metadata を前提に supported pattern の score 改善へ集中する。
...
Mermaid ZenUML 由来の failure は v0.1.3 の対象として扱い、v0.1.4 の score 改善完了条件には含めない。
