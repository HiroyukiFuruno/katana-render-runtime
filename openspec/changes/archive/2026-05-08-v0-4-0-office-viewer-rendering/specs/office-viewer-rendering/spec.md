...
KDR SHALL NOT implement Word, Excel, or PPTX viewer rendering after the KDV responsibility boundary is adopted.
...
- **THEN** KDR does not add Office viewer APIs, fixtures, or CLI entrypoints
