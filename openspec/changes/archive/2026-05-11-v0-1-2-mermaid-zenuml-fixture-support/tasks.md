# Tasks: katana-diagram-renderer v0.1.2 Mermaid ZenUML rendering
...
- [x] 2.2 `crates/katana-diagram-renderer/vendor/mermaid-zenuml/<version>/mermaid-zenuml.min.js` に固定配置する
