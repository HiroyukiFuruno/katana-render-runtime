...
- `crates/katana-diagram-renderer/src/markdown/*_renderer/js_runtime/`
- `crates/katana-diagram-renderer/src/markdown/*_renderer/js_runtime_scripts.rs`
- `crates/katana-diagram-renderer/src/markdown/diagram_runtime/source/`
...
- [x] 1.9 合意済み階層として `crates/katana-diagram-renderer/src/markdown/diagram_runtime/source/shared`、`source/mermaid`、`source/drawio`、`source/zenuml`、`generated` の配置を確定する
...
- `crates/kdr-linter/src/rules`
- `crates/kdr-linter/tests`
