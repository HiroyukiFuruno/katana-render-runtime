...
指定 version を取り込み、checksum、manifest、reference snapshot、compare を一括実行する。
...
- [ ] 4.4 update recipe が reference snapshot を再生成する
- [ ] 4.5 update recipe が compare を実行し、score 低下を検知する
