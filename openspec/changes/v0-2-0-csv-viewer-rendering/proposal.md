...
責務再整理により、CSV viewer renderingはKDVへ移譲する。KCFではこのchangeを実装開始しない。
...
- KCF側のv0.2.0としてはCSV viewer renderingを開始しない
...
- `openspec/changes/v0-2-0-csv-viewer-rendering/` — KCF側では移譲記録として維持
