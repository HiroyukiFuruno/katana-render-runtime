...
Mermaid の全 supported pattern も v0.1.7 の 99 点基準にそろえる。
...
- [ ] 4.6 `just VERSION=v0.1.7 release-check` を実行する
...
- [ ] 5.4 `npx -y @fission-ai/openspec validate "v0-1-7-reference-score-improvement" --strict` を実行する
