# Tasks: katana-canvas-forge v0.2.1 remove KDV migrated export

## 1. Definition of Ready

- [ ] 1.1 KDV v0.1.0がreleaseされている
- [ ] 1.2 KDV側でHTML / PDF / PNG / JPG export APIが定義されている
- [ ] 1.3 KatanAまたはKDV側でKCF exportに依存しない確認ができている
- [ ] 1.4 KCF v0.2.0でexportが新規公開範囲に含まれていない

## 2. Library Removal

- [ ] 2.1 KCF libraryのdocument export API利用箇所を棚卸しする
...
- [ ] 3.1 KCF CLIのdocument export commandを削除する
