...
v0.1.4 は、ZenUML を実際に support するか、unsupported として明示的に扱うかを固定する change である。
...
- `just check`
- `npx -y @fission-ai/openspec validate "v0-1-4-mermaid-zenuml-fixture-support" --strict`
