...
この範囲は旧 v0.1.1 / v0.1.2 として Jules 側へ渡していたが、粒度が大きく進捗が停滞している。Mermaid ZenUML / unsupported fixture handling を v0.1.4 として閉じ、score 改善（score improvement）を v0.1.5 の最終フェーズへ送る。旧export CSS debugはKDV移譲対象として v0.1.6 に送る。
...
- v0.1.4 で固定した unsupported fixture metadata を前提に、unsupported fixture を暗黙 skip しない
