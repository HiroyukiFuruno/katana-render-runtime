...
システムは、Word / Excel / PPTX それぞれに最小 case と代表 case を持ち、reference snapshot と viewer e2e で検証しなければならない（MUST）。
...
- **THEN** viewer e2e で reference artifact と kcf artifact を比較表示できる
